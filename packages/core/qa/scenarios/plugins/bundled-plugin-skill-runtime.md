...
successCriteria:
  - The runtime-packaged bundled plugin tree is used as BRIKKO_STUDIO_BUNDLED_PLUGINS_DIR.
          ...
          expr: |-
            (async () => {
              ...
              const cliEnv = {
                ...
                BRIKKO_STUDIO_OAUTH_DIR: path.join(stateDir, "credentials"),
                BRIKKO_STUDIO_BUNDLED_PLUGINS_DIR: distRuntimeExtensions,
