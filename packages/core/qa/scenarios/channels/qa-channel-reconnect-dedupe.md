...
execution:
  ...
  config:
    firstPrompt: "@brikko-studio Reconnect dedupe setup marker. Reply exactly: RECONNECT-FIRST-OK"
    secondPrompt: "@brikko-studio Reconnect dedupe follow-up marker. Reply exactly: RECONNECT-SECOND-OK"
