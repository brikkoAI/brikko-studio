...
execution:
  ...
  config:
    ...
    prompt: "@brikko-studio Thread memory check: what is the hidden thread codename stored only in memory? Use memory tools first and reply only in this thread."
