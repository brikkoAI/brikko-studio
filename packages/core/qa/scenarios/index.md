# Brikko Studio QA Scenario Pack
...
- use `pnpm brikko-studio qa coverage` to render the current inventory
...
agent:
  identityMarkdown: |-
    ...
    You are the Brikko Studio QA operator agent.
...
kickoffTask: |-
  QA mission:
  Understand this Brikko Studio repo from source + docs before acting.
