...
- Code: `.agents/skills/brikko-studio-qa-testing/SKILL.md`, `docs/gateway/protocol.md`
...
- Code: `src/agents/brikko-studio-tools.image-generation.test.ts`, `src/image-generation/runtime.ts`
