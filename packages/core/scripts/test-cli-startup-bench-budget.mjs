...
const opts = parseFlagArgs(
  process.argv.slice(2),
  {
    ...
    report: "",
    entry: "brikko-studio.mjs",
    preset: "all",
    runs: 1,
    warmup: 0,
    timeoutMs: 30_000,
    maxDurationRegressionPct:
      readEnvNumber("BRIKKO_STUDIO_STARTUP_BENCH_MAX_DURATION_REGRESSION_PCT") ?? 20,
    maxRssRegressionPct: readEnvNumber("BRIKKO_STUDIO_STARTUP_BENCH_MAX_RSS_REGRESSION_PCT") ?? 20,
  },
  [
