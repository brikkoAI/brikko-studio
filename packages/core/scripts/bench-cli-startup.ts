...
const DEFAULT_ENTRY = "brikko-studio.mjs";
...
Options:
  ...
  --entry <path>               Primary entry file (default: brikko-studio.mjs)
...
async function main(): Promise<void> {
  ...
  const tmpDir = mkdtempSync(path.join(os.tmpdir(), "brikko-studio-cli-bench-"));
