...
const env = {
  ...process.env,
  BRIKKO_STUDIO_LIVE_TEST: process.env.BRIKKO_STUDIO_LIVE_TEST || "1",
  BRIKKO_STUDIO_LIVE_TEST_QUIET: quietOverride ?? process.env.BRIKKO_STUDIO_LIVE_TEST_QUIET ?? "1",
};
...
const heartbeatMs = parsePositiveInt(process.env.BRIKKO_STUDIO_LIVE_WRAPPER_HEARTBEAT_MS, 20_000);
