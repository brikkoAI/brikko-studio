...
const ENV_PROVIDER = "BRIKKO_STUDIO_CONTROL_UI_I18N_PROVIDER";
const ENV_MODEL = "BRIKKO_STUDIO_CONTROL_UI_I18N_MODEL";
const ENV_THINKING = "BRIKKO_STUDIO_CONTROL_UI_I18N_THINKING";
const ENV_PI_EXECUTABLE = "BRIKKO_STUDIO_CONTROL_UI_I18N_PI_EXECUTABLE";
const ENV_PI_ARGS = "BRIKKO_STUDIO_CONTROL_UI_I18N_PI_ARGS";
const ENV_PI_PACKAGE_VERSION = "BRIKKO_STUDIO_CONTROL_UI_I18N_PI_PACKAGE_VERSION";
const ENV_BATCH_CHAR_BUDGET = "BRIKKO_STUDIO_CONTROL_UI_I18N_BATCH_CHAR_BUDGET";
const ENV_PROMPT_TIMEOUT = "BRIKKO_STUDIO_CONTROL_UI_I18N_PROMPT_TIMEOUT";
...
const DEFAULT_GLOSSARY: readonly GlossaryEntry[] = [
  { source: "Brikko Studio", target: "Brikko Studio" },
