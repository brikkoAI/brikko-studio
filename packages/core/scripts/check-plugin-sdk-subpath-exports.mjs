...
async function main() {
  ...
  if (violations.length === 0) {
    console.log("OK: all referenced brikko-studio/plugin-sdk/<subpath> imports are exported.");
    return;
  }

  console.error(
    "Rule: every referenced brikko-studio/plugin-sdk/<subpath> must exist in the public package exports.",
  );
