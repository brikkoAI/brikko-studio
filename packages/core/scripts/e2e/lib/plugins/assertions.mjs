...
function readBrikkoStudioConfig() {
  const configPath = path.join(process.env.HOME, ".brikko-studio", "brikko-studio.json");
...
function assertPluginRemoved(params) {
  ...
  const config = readBrikkoStudioConfig();
...
function recordFixturePluginTrust() {
  ...
  const ledger = fs.existsSync(ledgerPath)
    ...
    : {
        version: 1,
        warning:
          "DO NOT EDIT. This file is generated by BrikkoStudio plugin install/update/uninstall commands. Use `brikko-studio plugins install/update/uninstall` instead.",
        records: {},
      };
