...
read_when:
  - Planning a broad Brikko Studio application modernization pass
...
modernization task. If adopting this guidance as a repo-local Brikko Studio skill,
create `.agents/skills/brikko-studio-frontend/SKILL.md` first, keep the frontmatter
