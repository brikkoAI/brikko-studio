---
summary: Machine-checked security models for Brikko Studio’s highest-risk paths.
...
This page tracks Brikko Studio’s **formal security models** (TLA+/TLC today; more as needed).

> Note: some older links may refer to the previous project name.

**Goal (north star):** provide a machine-checked argument that Brikko Studio enforces its
...
**What this is not (yet):** a proof that “Brikko Studio is secure in all respects” or that the full TypeScript implementation is correct.

## Where the models live

Models are maintained in a separate repo: [vignesh07/brikko-studio-formal-models](https://github.com/vignesh07/brikko-studio-formal-models).
...
```bash
git clone https://github.com/vignesh07/brikko-studio-formal-models
cd brikko-studio-formal-models
