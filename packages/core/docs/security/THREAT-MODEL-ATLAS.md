---
summary: "Brikko Studio threat model mapped to the MITRE ATLAS framework"
...
# Brikko Studio Threat Model v1.0
...
This is a living document maintained by the Brikko Studio community. See [CONTRIBUTING-THREAT-MODEL.md](/security/CONTRIBUTING-THREAT-MODEL) for guidelines on contributing:
...
This threat model documents adversarial threats to the Brikko Studio AI agent platform and ClawHub skill marketplace, using the MITRE ATLAS framework designed specifically for AI/ML systems.

### 1.2 Scope

| Component              | Included | Notes                                            |
| ---------------------- | -------- | ------------------------------------------------ |
| Brikko Studio Agent Runtime | Yes      | Core agent execution, tool calls, sessions       |
...
| **Description**         | Attacker scans for exposed Brikko Studio gateway endpoints                |
...
| **Affected Components** | ~/.brikko-studio/credentials/, config storage                    |
...
| ATLAS ID      | Technique Name                 | Brikko Studio Threats                                                 |
| ------------- | ------------------------------ | ---------------------------------------------------------------- |
...
| **ClawHub**          | Brikko Studio's skill marketplace                              |
| **Gateway**          | Brikko Studio's message routing and authentication layer       |
| **MCP**              | Model Context Protocol - tool provider interface          |
| **Prompt Injection** | Attack where malicious instructions are embedded in input |
| **Skill**            | Downloadable extension for Brikko Studio agents                |
| **SSRF**             | Server-Side Request Forgery                               |

---

_This threat model is a living document. Report security issues to security@brikko-studio.ai_
