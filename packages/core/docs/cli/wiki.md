---
summary: "CLI reference for `brikko-studio wiki` (memory-wiki vault status, search, compile, lint, apply, bridge, and Obsidian helpers)"
read_when:
  - You want to use the memory-wiki CLI
  - You are documenting or changing `brikko-studio wiki`
title: "Wiki"
---
...
Use `brikko-studio wiki` when you want a compiled knowledge vault with:
...
```bash
brikko-studio wiki status
brikko-studio wiki doctor
brikko-studio wiki init
brikko-studio wiki ingest ./notes/alpha.md
brikko-studio wiki compile
brikko-studio wiki lint
brikko-studio wiki search "alpha"
brikko-studio wiki search "who should I ask about Teams?" --mode route-question
brikko-studio wiki get entity.alpha --from 1 --lines 80

brikko-studio wiki apply synthesis "Alpha Summary" \
  --body "Short synthesis body" \
  --source-id source.alpha

brikko-studio wiki apply metadata entity.alpha \
  --source-id source.alpha \
  --status review \
  --question "Still active?"

brikko-studio wiki bridge import
brikko-studio wiki unsafe-local import

brikko-studio wiki obsidian status
brikko-studio wiki obsidian search "alpha"
brikko-studio wiki obsidian open syntheses/alpha-summary.md
brikko-studio wiki obsidian command workspace:quick-switcher
brikko-studio wiki obsidian daily
```
...
- `.brikko-studio-wiki/cache/agent-digest.json`
- `.brikko-studio-wiki/cache/claims.jsonl`
...
For one broad shared recall pass, prefer `brikko-studio memory search` when the
...
```bash
brikko-studio wiki search "bgroux" --mode find-person
brikko-studio wiki search "who knows Teams rollout?" --mode route-question
brikko-studio wiki search "maintainer-whois" --mode source-evidence
brikko-studio wiki search "strong route Teams" --mode raw-claim --json
```
...
```bash
brikko-studio wiki get entity.alpha
brikko-studio wiki get syntheses/alpha-summary.md --from 1 --lines 80
```
...
`brikko-studio wiki` behavior is shaped by:
