...
Brikko Studio treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.brikko-studio/settings/voicewake.json`

Shape:

```json
{ "triggers": ["brikko-studio", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
