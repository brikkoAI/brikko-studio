---
summary: "Messaging platforms Brikko Studio can connect to"
read_when:
  - You want to choose a chat channel for Brikko Studio
  - You need a quick overview of supported messaging platforms
title: "Chat channels"
---

Brikko Studio can talk to you on any chat app you already use. Each channel connects via the Gateway.
...
- Channels can run simultaneously; configure multiple and Brikko Studio will route per chat.
