...
Zalo ships as a bundled plugin in current Brikko Studio releases, so normal packaged
...
- Install via CLI: `brikko-studio plugins install @brikko-studio/zalo`
- Pinned version: `brikko-studio plugins install @brikko-studio/zalo@2026.5.2`
- Or from a source checkout: `brikko-studio plugins install ./path/to/local/zalo-plugin`
...
This page reflects current Brikko Studio behavior for **Zalo Bot Creator / Marketplace bots**.
...
- Approve via:
  - `brikko-studio pairing list zalo`
  - `brikko-studio pairing approve zalo <CODE>`
...
This table summarizes current **Zalo Bot Creator / Marketplace bot** behavior in Brikko Studio.
...
- Example: `brikko-studio message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `brikko-studio channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `brikko-studio logs --follow`
