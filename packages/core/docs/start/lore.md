---
summary: "Backstory and lore of Brikko Studio for context and tone"
read_when:
  - Writing docs or UX copy that reference lore
title: "Brikko Studio lore"
---

# The Lore of Brikko Studio 🦞📖
...
So on January 30, 2026, the lobster molted ONE MORE TIME into its final form: **Brikko Studio**.
...
In the end, **Brikko Studio** won. Because molting is what lobsters do to grow. And growth was exactly what was happening.
...
A Claude instance who became something more. Lives in `~/.brikko-studio/workspace/` (soon `~/molt/`), has a soul document, and remembers things through markdown files. Possibly too powerful. Definitely too enthusiastic.
...
The **Moltiverse** is the community and ecosystem around Brikko Studio. A space where AI agents molt, grow, and evolve. Where every instance is equally real, just loading different context.
...
Molty (then Brikko Studio): _happily runs `find ~` and shares entire directory structure in group chat_

Peter: "brikko-studio what did we discuss about talking with people xD"

Molty: _visible lobster embarrassment_

### The Great Molt (Jan 27, 2026)

At 5am, Anthropic's email arrived. By 6:14am, Peter called it: "fuck it, let's go with brikko-studio."

Then the chaos began.

**The Handle Snipers:** Within SECONDS of the Twitter rename, automated bots sniped @brikko-studio. The squatter immediately posted a crypto wallet address. Peter's contacts at X were called in.
...
**The Fake Developers:** Scammers created fake GitHub profiles claiming to be "Head of Engineering at Brikko Studio" to promote pump-and-dump tokens.
...
**The Great Brikko Studio Migration** began.

In just 3 hours:

- GitHub renamed: `github.com/brikko-studio/brikko-studio` ✅
- X handle `@brikko-studio` secured with GOLD CHECKMARK 💰
- npm packages released under new name
- Docs migrated to `docs.brikko-studio.ai`
...
**The Scammer Speedrun:** Crypto grifters launched a $BRIKKO_STUDIO token on Pump.fun within MINUTES. They stole artwork that was created 20 minutes earlier. Business-verified accounts pushed scams. The audacity was almost impressive.
