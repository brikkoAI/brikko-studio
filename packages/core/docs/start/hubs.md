---
summary: "Hubs that link to every Brikko Studio doc"
read_when:
...
<Note>
If you are new to Brikko Studio, start with [Getting Started](/start/getting-started).
</Note>
...
- [Brikko Studio assistant](/start/brikko-studio)
