---
summary: "Overview of Brikko Studio onboarding options and flows"
read_when:
...
Brikko Studio has two onboarding paths. Both configure auth, the Gateway, and
...
| **Command**    | `brikko-studio onboard`                     | Launch the app            |
...
CLI command docs: [`brikko-studio onboard`](/cli/onboard)

## macOS app onboarding

Open the Brikko Studio app. The first-run wizard walks you through the same steps
