---
summary: "First-run setup flow for Brikko Studio (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give Brikko Studio">
...
<Step title="CLI">
  ...
  The app can install the global `brikko-studio` CLI via npm, pnpm, or bun.
