...
<Steps>
  <Step title="Install the plugin">
    ```bash
    brikko-studio plugins install diffs
    ```
  </Step>
...
- Artifacts are stored under the temp subfolder: `$TMPDIR/brikko-studio-diffs`.
...
<Steps>
  <Step title="Config">
    `browser.executablePath` in Brikko Studio config.
  </Step>
