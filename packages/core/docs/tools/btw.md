...
It is modeled after Claude Code's `/btw` behavior, but adapted to Brikko Studio's
...
If the main run is currently active, Brikko Studio snapshots the current message
