---
summary: "Use SOUL.md to give your Brikko Studio agent an actual voice instead of generic assistant sludge"
read_when:
...
Brikko Studio injects it on normal sessions, so it has real weight. If your agent
...
For Brikko Studio, `SOUL.md` is that layer.
...
Path fixed for Brikko Studio workspaces: use `SOUL.md`, not `http://SOUL.md`.
