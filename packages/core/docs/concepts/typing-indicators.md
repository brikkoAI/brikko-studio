---
summary: "When Brikko Studio shows typing indicators and how to tune them"
read_when:
...
When `agents.defaults.typingMode` is **unset**, Brikko Studio keeps the legacy behavior:
