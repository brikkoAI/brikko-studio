...
Brikko Studio standardizes timestamps so the model sees a **single reference time**.
...
unset, Brikko Studio resolves the **host timezone at runtime** (no config write).
