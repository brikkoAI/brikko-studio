...
Brikko Studio also builds a separate idempotent replay view for sessions that
...
Brikko Studio auto-enables pruning for Anthropic profiles:
...
If you set explicit values, Brikko Studio does not override them.
