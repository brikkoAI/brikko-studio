...
read_when:
  - You want to use Cloudflare AI Gateway with Brikko Studio
  - You need the account ID, gateway ID, or API key env var
---

Cloudflare AI Gateway sits in front of provider APIs and lets you add analytics, caching, and controls. For Anthropic, Brikko Studio uses the Anthropic Messages API through your Gateway endpoint.
...
When thinking is enabled for Anthropic Messages models, Brikko Studio strips trailing
...
<Steps>
  <Step title="Set the provider API key and Gateway details">
    ...
    ```bash
    brikko-studio onboard --auth-choice cloudflare-ai-gateway-api-key
    ```
  ...
  <Step title="Set a default model">
    Add the model to your Brikko Studio config:
  ...
  <Step title="Verify the model is available">
    ```bash
    brikko-studio models list --provider cloudflare-ai-gateway
    ```
  </Step>
</Steps>
