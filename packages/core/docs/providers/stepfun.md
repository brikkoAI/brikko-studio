---
summary: "Use StepFun models with Brikko Studio"
read_when:
  - You want StepFun models in Brikko Studio
  - You need StepFun setup guidance
title: "StepFun"
---

Brikko Studio includes a bundled StepFun provider plugin with two provider ids:
    ...
    **Best for:** general-purpose use via the standard StepFun endpoint.
    ...
    <Steps>
      ...
      <Step title="Run onboarding">
        ```bash
        brikko-studio onboard --auth-choice stepfun-standard-api-key-intl
        ```

        Or for the China endpoint:

        ```bash
        brikko-studio onboard --auth-choice stepfun-standard-api-key-cn
        ```
      </Step>
      ...
      <Step title="Verify models are available">
        ```bash
        brikko-studio models list --provider stepfun
        ```
      </Step>
    </Steps>
  ...
  <Tab title="Step Plan">
    **Best for:** Step Plan reasoning endpoint.
    ...
    <Steps>
      ...
      <Step title="Run onboarding">
        ```bash
        brikko-studio onboard --auth-choice stepfun-plan-api-key-intl
        ```

        Or for the China endpoint:

        ```bash
        brikko-studio onboard --auth-choice stepfun-plan-api-key-cn
        ```
      </Step>
      <Step title="Non-interactive alternative">
        ```bash
      ...
      <Step title="Verify models are available">
        ```bash
        brikko-studio models list --provider stepfun-plan
        ```
      </Step>
    </Steps>
...
<AccordionGroup>
  ...
  <Accordion title="Notes">
    - The provider is bundled with Brikko Studio, so there is no separate plugin install step.
    ...
    - Use `brikko-studio models list` and `brikko-studio models set <provider/model>` to inspect or switch models.
