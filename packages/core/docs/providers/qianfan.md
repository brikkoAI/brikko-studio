---
summary: "Use Qianfan's unified API to access many models in Brikko Studio"
read_when:
...
<Steps>
  ...
  <Step title="Run onboarding">
    ```bash
    brikko-studio onboard --auth-choice qianfan-api-key
    ```
  </Step>
  <Step title="Verify the model is available">
    ```bash
    brikko-studio models list --provider qianfan
    ```
  </Step>
</Steps>
