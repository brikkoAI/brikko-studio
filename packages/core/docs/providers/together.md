...
title: "Together AI"
read_when:
  - You want to use Together AI with Brikko Studio
...
<Steps>
  ...
  <Step title="Run onboarding">
    ```bash
    brikko-studio onboard --auth-choice together-api-key
    ```
  </Step>
...
Brikko Studio ships this bundled Together catalog:
...
<AccordionGroup>
  ...
  <Accordion title="Troubleshooting">
    - Verify your key works: `brikko-studio models list --provider together`
