...
<Steps>
  ...
  <Step title="Configure Brikko Studio">
    Point Brikko Studio at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Brikko Studio
...
<CardGroup cols={2}>
  <Card title="Anthropic provider" href="/providers/anthropic" icon="bolt">
    Native Brikko Studio integration with Claude CLI or API keys.
  </Card>
