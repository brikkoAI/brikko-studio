# Brikko Studio iOS Versioning

Brikko Studio iOS uses a **pinned CalVer release version** instead of reading the current gateway version automatically on every build.
