...
export const INSTALLED_PLUGIN_INDEX_WARNING =
  "DO NOT EDIT. This file is generated by BrikkoStudio from plugin manifests, install records, and config policy. Use `brikko-studio plugins registry --refresh`, `brikko-studio plugins install/update/uninstall`, or `brikko-studio plugins enable/disable` instead.";
