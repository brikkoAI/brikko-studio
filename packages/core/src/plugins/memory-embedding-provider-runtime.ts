...
function readConfiguredProviderApiId(providerId: string, cfg?: Brikko StudioConfig): string | undefined {
...
function resolveMemoryEmbeddingProviderLookupIds(id: string, cfg?: Brikko StudioConfig): string[] {
  const ids = [id];
