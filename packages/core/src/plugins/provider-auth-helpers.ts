...
const resolveAuthAgentDir = (agentDir?: string) => agentDir ?? resolveBrikko StudioAgentDir();
...
function resolveProviderDefaultEnvSecretRef(provider: string, config?: Brikko StudioConfig): SecretRef {
