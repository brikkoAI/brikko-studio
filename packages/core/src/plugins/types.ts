...
export type ProviderPlugin = {
  ...
  /**
   * Legacy auth-profile ids that should be retired by `brikko-studio doctor`.
   *
  ...
  /**
   * Legacy OAuth profile-id migrations that `brikko-studio doctor` should offer.
   *
...
/** Migration source implemented by a plugin and orchestrated by `brikko-studio migrate`. */
...
export type BrikkoStudioPluginApi = {
  ...
  /** Register an importer for `brikko-studio migrate` (migration capability). */
