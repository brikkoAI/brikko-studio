...
export const PLUGIN_MANIFEST_FILENAME = "brikko-studio.plugin.json";
...
export type PluginManifestQaRunner = {
  /** Subcommand mounted beneath `brikko-studio qa`, for example `matrix`. */
  commandName: string;
...
// package.json "brikko-studio" metadata (used for setup/catalog)
