...
function resolveDefaultStoreAgentId(cfg: Brikko StudioConfig): string {
...
export function resolveSessionStoreAgentId(cfg: Brikko StudioConfig, canonicalKey: string): string {
