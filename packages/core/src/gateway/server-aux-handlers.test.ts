...
function createSnapshot(config: Brikko StudioConfig): PreparedSecretsRuntimeSnapshot {
  return {
...
// set BRIKKO_STUDIO_SKIP_CHANNELS / BRIKKO_STUDIO_SKIP_PROVIDERS at module load. When a
