...
export function hasAmbiguousGatewayAuthModeConfig(cfg: Brikko StudioConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: Brikko StudioConfig): void {
