  ...
  constructor(path: string) {
    super(
      [
        ...
        "Fix: set BRIKKO_STUDIO_GATEWAY_TOKEN/BRIKKO_STUDIO_GATEWAY_PASSWORD, pass explicit --token/--password,",
...
export function resolveGatewayCredentialsFromConfig(params: {
  ...
  const localTokenPrecedence =
    ...
    (env.BRIKKO_STUDIO_SERVICE_KIND === "gateway" ? "config-first" : "env-first");
