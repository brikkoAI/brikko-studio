...
type GatewayInstallAuthMode = NonNullable<NonNullable<BrikkoStudioConfig["gateway"]>["auth"]>["mode"];
...
function hasConfiguredGatewayPasswordForInstall(cfg: BrikkoStudioConfig): boolean {
