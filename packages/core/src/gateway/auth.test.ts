...
describe("gateway auth", () => {
  ...
  it("resolves token/password from BRIKKO_STUDIO gateway env vars", () => {
    expect(
      resolveGatewayAuth({
        authConfig: {},
        env: {
  ...
  it("accepts password mode when env provides BRIKKO_STUDIO_GATEWAY_PASSWORD", () => {
...
describe("trusted-proxy auth", () => {
  ...
  it.each([
    ...
    },
    {
      ...
      env: {
        BRIKKO_STUDIO_GATEWAY_TOKEN: "shared-secret",
      } as NodeJS.ProcessEnv,
    },
