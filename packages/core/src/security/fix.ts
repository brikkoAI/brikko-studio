...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof BrikkoStudioConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: BrikkoStudioConfig; env: NodeJS.ProcessEnv }): {
  cfg: BrikkoStudioConfig;
  changes: string[];
} {
