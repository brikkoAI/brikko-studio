...
export function createConfigWriteAuditRecordBase(params: {
  ...
  return {
    ...
    watchMode: params.env.BRIKKO_STUDIO_WATCH_MODE === "1",
    watchSession: normalizeAuditLabel(params.env.BRIKKO_STUDIO_WATCH_SESSION),
    watchCommand: normalizeAuditLabel(params.env.BRIKKO_STUDIO_WATCH_COMMAND),
