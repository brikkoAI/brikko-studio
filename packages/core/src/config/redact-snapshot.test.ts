...
import type { ConfigFileSnapshot } from "./types.brikko-studio.js";
...
describe("redactConfigSnapshot", () => {
          ...
          plugins: [
            {
              ...
              manifestPath: "/private/plugin/root/brikko-studio.plugin.json",
            },
          ],
          diagnostics: [],
        },
  ...
  it("does not redact passwordFile path fields", () => {
    const snapshot = makeSnapshot({
      channels: {
        irc: {
          passwordFile: "/etc/brikko-studio/irc-password.txt",
          nickserv: {
            passwordFile: "/etc/brikko-studio/nickserv-password.txt",
    ...
    expect(irc.passwordFile).toBe("/etc/brikko-studio/irc-password.txt");
    expect(nickserv.passwordFile).toBe("/etc/brikko-studio/nickserv-password.txt");
