...
function resolveRealtimeVoiceProviderEntries(cfg?: BrikkoStudioConfig): RealtimeVoiceProviderPlugin[] {
...
export function listRealtimeVoiceProviders(cfg?: BrikkoStudioConfig): RealtimeVoiceProviderPlugin[] {
