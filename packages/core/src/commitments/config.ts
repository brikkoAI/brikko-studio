...
export function resolveCommitmentsConfig(cfg?: BrikkoStudioConfig): ResolvedCommitmentsConfig {
...
export function resolveCommitmentTimezone(cfg?: BrikkoStudioConfig): string {
