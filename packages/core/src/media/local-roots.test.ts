...
describe("local media roots", () => {
  ...
  it.each([
    {
      ...
      stateDir: path.join("/tmp", "brikko-studio-media-roots-state"),
    ...
    },
    {
      ...
      stateDir: path.join("/tmp", "brikko-studio-agent-media-roots-state"),
  ...
  it.each([
    {
      ...
      stateDir: path.join("/tmp", "brikko-studio-flexible-media-roots-state"),
      cfg: {},
    ...
    },
    {
      ...
      stateDir: path.join("/tmp", "brikko-studio-messaging-media-roots-state"),
    ...
    },
    {
      ...
      stateDir: path.join("/tmp", "brikko-studio-messaging-fs-media-roots-state"),
      cfg: {
        tools: {
          profile: "messaging",
    ...
    },
    {
      ...
      stateDir: path.join("/tmp", "brikko-studio-messaging-read-media-roots-state"),
      cfg: {
        tools: {
          profile: "messaging",
  ...
  it("keeps the config-dir media cache root when state and config paths differ", () => {
    const stateDir = path.join("/tmp", "brikko-studio-legacy-state");
    const configDir = path.join("/tmp", "brikko-studio-current-config");
