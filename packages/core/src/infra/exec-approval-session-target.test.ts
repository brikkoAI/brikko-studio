...
function resolveSlackPluginOriginTarget(params: { cfg: Brikko StudioConfig; turnSourceTo: string }) {
...
describe("exec approval session target", () => {
  ...
  it("returns null for blank session keys, missing entries, and unresolved targets", () => {
    withTempDirSync({ prefix: "brikko-studio-exec-approval-session-target-" }, (tmpDir) => {
