...
export async function resolveControlUiDistIndexPath(
  ...
  // Fallback: traverse up and find package.json with name "brikko-studio" + dist/control-ui/index.html
...
export function resolveControlUiRootSync(opts: ControlUiRootResolveOptions = {}): string | null {
  ...
  if (argv1Dir) {
    // brikko-studio.mjs or dist/<bundle>.js
  ...
  if (argv1RealpathDir && argv1RealpathDir !== argv1Dir) {
    // Symlinked wrappers (e.g. ~/.bun/bin/brikko-studio -> .../dist/index.js)
