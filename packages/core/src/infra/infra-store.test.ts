...
describe("infra store", () => {
  describe("state migrations fs", () => {
    it("treats array session stores as invalid", async () => {
      await withTempDir("brikko-studio-session-store-", async (dir) => {
  ...
  describe("voicewake store", () => {
    it("returns defaults when missing", async () => {
      await withTempDir("brikko-studio-voicewake-", async (baseDir) => {
  ...
  describe("voicewake routing store", () => {
    it("returns defaults when missing", async () => {
      const baseDir = await fs.mkdtemp(path.join(os.tmpdir(), "brikko-studio-voicewake-routing-"));
