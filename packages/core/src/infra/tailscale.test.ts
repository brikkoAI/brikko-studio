...
describe("tailscale helpers", () => {
  ...
  beforeEach(() => {
    envSnapshot = captureEnv(["BRIKKO_STUDIO_TEST_TAILSCALE_BINARY", "NODE_ENV", "VITEST"]);
    process.env.BRIKKO_STUDIO_TEST_TAILSCALE_BINARY = "tailscale";
  ...
  it("allows the test binary override in explicit test environments", () => {
    process.env.BRIKKO_STUDIO_TEST_TAILSCALE_BINARY = "/tmp/test-tailscale";
  ...
  it("ignores the test binary override outside test environments", () => {
    process.env.BRIKKO_STUDIO_TEST_TAILSCALE_BINARY = "/tmp/attacker-tailscale";
