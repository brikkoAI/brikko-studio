...
let cachedBrikkoStudioPackageRoot: string | undefined;
...
function getBrikkoStudioPackageRoot() {
  if (cachedBrikkoStudioPackageRoot) {
    return cachedBrikkoStudioPackageRoot;
  }
  cachedBrikkoStudioPackageRoot =
...
function resolveFacadeModuleLocation(params: {
  ...
  return resolveBundledFacadeModuleLocation({
    ...
    packageRoot: getBrikkoStudioPackageRoot(),
    bundledPluginsDir,
  });
}
...
export function loadFacadeModuleAtLocationSync<T extends object>(params: {
  ...
  const opened = openBoundaryFileSync({
    ...
    boundaryLabel:
      location.boundaryRoot === getBrikkoStudioPackageRoot()
        ? "BrikkoStudio package root"
        : (() => {
...
export async function loadBundledPluginPublicSurfaceModule<T extends object>(params: {
  ...
  const opened = openBoundaryFileSync({
    ...
    boundaryLabel:
      preparedLocation.boundaryRoot === getBrikkoStudioPackageRoot()
        ? "BrikkoStudio package root"
        : "plugin root",
    rejectHardlinks: false,
  });
...
export function resetFacadeLoaderStateForTest(): void {
  ...
  cachedBrikkoStudioPackageRoot = undefined;
}
