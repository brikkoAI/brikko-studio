...
export type { BrikkoStudioConfig, ModelApi, ModelDefinitionConfig, ModelProviderConfig };
export {
...
export type ProviderOnboardPresetAppliers<TArgs extends unknown[]> = {
  applyProviderConfig: (cfg: BrikkoStudioConfig, ...args: TArgs) => BrikkoStudioConfig;
  applyConfig: (cfg: BrikkoStudioConfig, ...args: TArgs) => BrikkoStudioConfig;
};
...
>(params: {
  ...
  applyPreset: (cfg: BrikkoStudioConfig, preset: TParams) => BrikkoStudioConfig;
  primaryModelRef: string;
...
export function applyOpencodeZenModelDefault(cfg: BrikkoStudioConfig): {
