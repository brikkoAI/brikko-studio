...
const BRIKKO_STUDIO_SOURCE_EXTENSIONS_ROOT = path.resolve(BRIKKO_STUDIO_PACKAGE_ROOT, "extensions");
...
function resolveFacadeModuleLocationUncached(params: {
  ...
  const bundledLocation = resolveBundledFacadeModuleLocation({
    ...
    packageRoot: BRIKKO_STUDIO_PACKAGE_ROOT,
    bundledPluginsDir,
  });
  if (bundledLocation) {
...
function buildFacadeActivationCheckParams(
  ...
  return {
    ...params,
    location,
    sourceExtensionsRoot: BRIKKO_STUDIO_SOURCE_EXTENSIONS_ROOT,
    resolutionKey: createFacadeResolutionKey(params),
  };
}
