...
export { VERSION as BRIKKO_STUDIO_VERSION } from "../version.js";
...
export { resolveBrikko StudioAgentDir } from "../agents/agent-paths.js";
 ...
 * preserve the same Brikko Studio-owned fallback signals as the built-in PI path
