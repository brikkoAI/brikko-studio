...
type LoginOpenAICodexOAuth =
  (typeof import("brikko-studio/plugin-sdk/provider-auth-login"))["loginOpenAICodexOAuth"];
type GithubCopilotLoginCommand =
  (typeof import("brikko-studio/plugin-sdk/provider-auth-login"))["githubCopilotLoginCommand"];
type EnsureAuthProfileStore =
  typeof import("brikko-studio/plugin-sdk/provider-auth").ensureAuthProfileStore;
type ListProfilesForProvider =
  typeof import("brikko-studio/plugin-sdk/provider-auth").listProfilesForProvider;
...
function installSharedAuthProfileStoreHooks(state: { authStore: AuthProfileStore }) {
  beforeEach(() => {
    vi.doMock("brikko-studio/plugin-sdk/provider-auth-login", async () => {
      const actual = await vi.importActual<
        typeof import("brikko-studio/plugin-sdk/provider-auth-login")
      >("brikko-studio/plugin-sdk/provider-auth-login");
      return {
        ...actual,
    ...
    vi.doMock("brikko-studio/plugin-sdk/provider-auth", async () => {
      const actual = await vi.importActual<typeof import("brikko-studio/plugin-sdk/provider-auth")>(
        "brikko-studio/plugin-sdk/provider-auth",
      );
      return {
        ...actual,
