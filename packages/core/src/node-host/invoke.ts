...
const execHostEnforced =
  normalizeLowercaseStringOrEmpty(process.env.BRIKKO_STUDIO_NODE_EXEC_HOST ?? "") === "app";
const execHostFallbackAllowed =
  normalizeLowercaseStringOrEmpty(process.env.BRIKKO_STUDIO_NODE_EXEC_FALLBACK ?? "") !== "0";
