...
describe("status-all format", () => {
  ...
  it("formats dashboard values consistently", () => {
    expect(formatStatusDashboardValue("https://brikko-studio.local")).toBe("https://brikko-studio.local");
  ...
  it("builds overview rows with shared ordering", () => {
    expect(
      buildStatusOverviewRows({
        ...
        dashboardValue: "https://brikko-studio.local",
        ...
        middleRows: [{ Item: "Security", Value: "Run: brikko-studio security audit --deep" }],
      ...
      { Item: "Dashboard", Value: "https://brikko-studio.local" },
      ...
      { Item: "Security", Value: "Run: brikko-studio security audit --deep" },
