  ...
  if (authMode === "trusted-proxy") {
    note(
      [
        ...
        "Docs: https://docs.brikko-studio.ai/gateway/trusted-proxy-auth",
      ].join("\n"),
      "Trusted Proxy Auth",
    );
