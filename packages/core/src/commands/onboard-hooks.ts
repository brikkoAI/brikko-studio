...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.brikko-studio.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("brikko-studio hooks list")}`,
      `  ${formatCliCommand("brikko-studio hooks enable <name>")}`,
      `  ${formatCliCommand("brikko-studio hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
