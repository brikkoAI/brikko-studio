...
export function scanLegacyToolsBySenderKeys(cfg: Brikko StudioConfig): LegacyToolsBySenderKeyHit[] {
...
export function maybeRepairLegacyToolsBySenderKeys(cfg: Brikko StudioConfig): {
