...
function recoveryHintForGatewayHealthFailure(
  ...
  switch (classification) {
    case "auth-mismatch":
      return "Fix: run `brikko-studio doctor --fix`.";
    case "module-missing":
      return "Fix: run `brikko-studio doctor --fix`.";
    case "service-missing":
      return "Fix: run `brikko-studio gateway install --force`.";
    case "service-stopped":
      return "Fix: run `brikko-studio gateway restart`.";
    case "startup-blocked":
      return "Fix: run `brikko-studio gateway status --deep`.";
    case "not-listening":
      return "Fix: start `brikko-studio gateway run`, or run `brikko-studio gateway restart` for a managed gateway.";
    default:
      return undefined;
  }
}
