...
function resolveMentionPatterns(cfg: Brikko StudioConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: Brikko StudioConfig | undefined, agentId?: string): RegExp[] {
