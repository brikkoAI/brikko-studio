...
const emptyCfg = {} as Brikko StudioConfig;
...
describe("resolveReplyToMode", () => {
  ...
  it("uses registered channel threading adapters for runtime reply-mode resolution", () => {
    ...
    expect(resolveReplyToMode({} as Brikko StudioConfig, "whatsapp", "work", "group")).toBe("first");
    expect(resolveReplyToMode({} as Brikko StudioConfig, "whatsapp", "default", "group")).toBe("all");
  });
});
