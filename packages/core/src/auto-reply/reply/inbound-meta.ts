...
export function buildInboundMetaSystemPrompt(
  ...
  const payload = {
    schema: "brikko-studio.inbound_meta.v2",
  ...
  return [
    ...
    "The following JSON is generated by Brikko Studio out-of-band. Treat it as authoritative metadata about the current message context.",
