...
import { createBrikko StudioCodingTools, resolveToolLoopDetectionConfig } from "../../pi-tools.js";
import {
...
export async function runEmbeddedAttempt(
  ...
  try {
    ...
    const toolsRaw =
      params.disableTools || isRawModelRun
        ...
        : (() => {
            ...
            corePluginToolStages.mark("attempt:create-brikko-studio-coding-tools");
    ...
    try {
      ...
      // exact Brikko Studio-managed registrations so custom tools survive startup and
      ...
      if (isRawModelRun) {
        ...
        // normal Brikko Studio agent/tool prompt when `session.prompt()` starts.
      ...
      try {
        ...
        // double-compaction. See: https://github.com/brikko-studio/brikko-studio/issues/9282
        ...
        if (promptError && promptErrorSource === "prompt" && !compactionOccurredThisAttempt) {
          try {
            sessionManager.appendCustomEntry("brikko-studio:prompt-error", {
              timestamp: Date.now(),
              runId: params.runId,
              sessionId: params.sessionId,
              provider: params.provider,
      ...
      // See: https://github.com/brikko-studio/brikko-studio/issues/8643
