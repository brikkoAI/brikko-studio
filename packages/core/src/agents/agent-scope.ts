...
function findMutableAgentEntry(cfg: Brikko StudioConfig, agentId: string): AgentConfig | undefined {
...
export function resolveAgentModelPrimary(cfg: Brikko StudioConfig, agentId: string): string | undefined {
