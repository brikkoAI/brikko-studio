...
type Brikko StudioReadToolOptions = {
...
function resolveAdaptiveReadMaxBytes(options?: Brikko StudioReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createBrikko StudioReadTool(base, {
...
export function createBrikko StudioReadTool(
  base: AnyAgentTool,
  options?: Brikko StudioReadToolOptions,
): AnyAgentTool {
  return {
    ...base,
