...
const STALE_ACTIVE_SUBAGENT_GRACE_MS = process.env.BRIKKO_STUDIO_TEST_FAST === "1" ? 1_000 : 60_000;
...
function resolveSubagentWaitTimeoutMs(cfg: Brikko StudioConfig, runTimeoutSeconds?: number) {
