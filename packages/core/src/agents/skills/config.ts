...
export function isConfigPathTruthy(config: BrikkoStudioConfig | undefined, pathStr: string): boolean {
...
export function resolveBundledAllowlist(config?: BrikkoStudioConfig): string[] | undefined {
