 ...
 * @see https://github.com/brikko-studio/brikko-studio/issues/36280
 */
...
export function applySkillEnvOverrides(params: { skills: SkillEntry[]; config?: Brikko StudioConfig }) {
  const { skills } = params;
