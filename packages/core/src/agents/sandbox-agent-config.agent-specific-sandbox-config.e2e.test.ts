...
async function resolveContext(config: BrikkoStudioConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): BrikkoStudioConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
