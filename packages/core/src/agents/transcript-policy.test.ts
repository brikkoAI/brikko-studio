      ...
      return {
        buildReplayPolicy: (context?: {
          ...
          switch (provider) {
            case "env-sensitive":
              return {
                sanitizeToolCallIds: context?.env?.BRIKKO_STUDIO_TEST_TRANSCRIPT_POLICY === "strict",
                ...(context?.env?.BRIKKO_STUDIO_TEST_TRANSCRIPT_POLICY === "strict"
...
describe("resolveTranscriptPolicy", () => {
  ...
  it("does not reuse cached replay policies across custom env objects", () => {
    ...
    const looseEnv = {
      ...process.env,
      BRIKKO_STUDIO_TEST_TRANSCRIPT_POLICY: "loose",
    };
