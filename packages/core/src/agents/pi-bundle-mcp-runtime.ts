...
const SESSION_MCP_RUNTIME_MANAGER_KEY = Symbol.for("brikko-studio.sessionMcpRuntimeManager");
...
function resolveSessionMcpRuntimeIdleTtlMs(cfg?: Brikko StudioConfig): number {
