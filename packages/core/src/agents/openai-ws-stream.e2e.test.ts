 ...
 *   BRIKKO_STUDIO_LIVE_TEST=1 pnpm test:e2e -- src/agents/openai-ws-stream.e2e.test.ts
 *
...
const LIVE_MODEL_ID = process.env.BRIKKO_STUDIO_LIVE_OPENAI_MODEL || "gpt-5.4";
