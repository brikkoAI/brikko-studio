...
export function createPiToolsSandboxContext(params: PiToolsSandboxContextParams): SandboxContext {
  ...
  return {
    ...
    runtimeId: params.containerName ?? "brikko-studio-sbx-test",
    runtimeLabel: params.containerName ?? "brikko-studio-sbx-test",
    containerName: params.containerName ?? "brikko-studio-sbx-test",
