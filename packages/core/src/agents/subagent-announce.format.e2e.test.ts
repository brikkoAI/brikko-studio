...
describe("subagent announce formatting", () => {
  ...
  beforeAll(async () => {
    ...
    // See: https://github.com/brikko-studio/brikko-studio/issues/31298
    previousFastTestEnv = process.env.BRIKKO_STUDIO_TEST_FAST;
  ...
  afterAll(() => {
    ...
    process.env.BRIKKO_STUDIO_TEST_FAST = previousFastTestEnv;
  });
  ...
  beforeEach(() => {
    vi.useRealTimers();
    resetAnnounceQueuesForTests();
    // BRIKKO_STUDIO_TEST_FAST is set in beforeAll before module import
