...
function createSandboxContext(overrides?: Partial<SandboxContext>): SandboxContext {
  const base = {
    ...
    workspaceDir: "/tmp/brikko-studio-sandbox",
    agentWorkspaceDir: "/tmp/brikko-studio-workspace",
    workspaceAccess: "none",
    runtimeId: "brikko-studio-sbx-test",
    runtimeLabel: "brikko-studio-sbx-test",
    containerName: "brikko-studio-sbx-test",
    ...
    browser: {
      ...
      containerName: "brikko-studio-sbx-browser-test",
    },
