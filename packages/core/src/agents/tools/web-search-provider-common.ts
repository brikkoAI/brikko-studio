...
export type SearchConfigRecord = (NonNullable<Brikko StudioConfig["tools"]>["web"] extends infer Web
...
export function parseIsoDateRange(params: {
  ...
  const docs = params.docs ?? "https://docs.brikko-studio.ai/tools/web";
