...
const formatDoctorNonInteractiveHintMock = vi.fn(() => "Run: brikko-studio doctor --non-interactive");
...
describe("gateway tool restart continuation", () => {
  beforeEach(() => {
    ...
    formatDoctorNonInteractiveHintMock.mockReturnValue("Run: brikko-studio doctor --non-interactive");
