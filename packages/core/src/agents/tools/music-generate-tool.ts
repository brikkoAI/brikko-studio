...
function hasExplicitMusicGenerationModelConfig(cfg?: BrikkoStudioConfig): boolean {
...
export function createMusicGenerateTool(options?: {
  ...
  return {
    ...
    description:
      "Generate music using configured providers. Generated tracks are saved under BrikkoStudio-managed media storage and delivered automatically as attachments.",
