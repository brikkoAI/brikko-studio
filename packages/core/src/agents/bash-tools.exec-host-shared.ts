...
export function buildHeadlessExecApprovalDeniedMessage(params: {
  ...
  return [
    ...
    "Stricter values from tools.exec and ~/.brikko-studio/exec-approvals.json both apply.",
    "Fix one of these:",
    ...
    'Tip: run "brikko-studio doctor" and "brikko-studio approvals get --gateway" to inspect the effective policy.',
  ].join("\n");
}
