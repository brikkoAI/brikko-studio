...
function resolveResolutionLimits(config: Brikko StudioConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: Brikko StudioConfig): SecretProviderConfig {
