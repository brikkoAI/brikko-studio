...
declare const __BRIKKO_STUDIO_VERSION__: string | undefined;
const CORE_PACKAGE_NAME = "brikko-studio";
...
function resolveVersionFromRuntimeSources(params: {
  ...
  const preferredCandidates =
    params.preference === "env-first"
      ? [params.env["BRIKKO_STUDIO_VERSION"], params.runtimeVersion]
      : [params.runtimeVersion, params.env["BRIKKO_STUDIO_VERSION"]];
  return (
    firstNonEmpty(
      ...preferredCandidates,
      params.env["BRIKKO_STUDIO_SERVICE_VERSION"],
...
export function resolveCompatibilityHostVersion(
  ...
  const explicitCompatibilityVersion = firstNonEmpty(env.BRIKKO_STUDIO_COMPATIBILITY_HOST_VERSION);
...
export const VERSION = resolveBinaryVersion({
  ...
  injectedVersion: typeof __BRIKKO_STUDIO_VERSION__ === "string" ? __BRIKKO_STUDIO_VERSION__ : undefined,
  bundledVersion: process.env.BRIKKO_STUDIO_BUNDLED_VERSION,
});
