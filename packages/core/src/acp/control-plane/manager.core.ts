...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: BrikkoStudioConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: BrikkoStudioConfig): AcpManagerObservabilitySnapshot {
  ...
  private resolveTurnTimeoutMs(params: { cfg: BrikkoStudioConfig; meta: SessionAcpMeta }): number {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: BrikkoStudioConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(params: { cfg: BrikkoStudioConfig }): Promise<void> {
