...
export type Brikko StudioHookMetadata = {
  always?: boolean;
  hookKey?: string;
  emoji?: string;
  homepage?: string;
...
export type Hook = {
  name: string;
  description: string;
  source: "brikko-studio-bundled" | "brikko-studio-managed" | "brikko-studio-workspace" | "brikko-studio-plugin";
  pluginId?: string;
...
export type HookEntry = {
  ...
  metadata?: Brikko StudioHookMetadata;
