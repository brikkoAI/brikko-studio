...
const HOOK_SOURCE_POLICIES: Record<HookSource, HookSourcePolicy> = {
  "brikko-studio-bundled": {
    precedence: 10,
    trustedLocalCode: true,
    defaultEnableMode: "default-on",
    canOverride: ["brikko-studio-bundled"],
    canBeOverriddenBy: ["brikko-studio-managed", "brikko-studio-plugin"],
  },
  "brikko-studio-plugin": {
    precedence: 20,
    trustedLocalCode: true,
    defaultEnableMode: "default-on",
    canOverride: ["brikko-studio-bundled", "brikko-studio-plugin"],
    canBeOverriddenBy: ["brikko-studio-managed"],
  },
  "brikko-studio-managed": {
    precedence: 30,
    trustedLocalCode: true,
    defaultEnableMode: "default-on",
    canOverride: ["brikko-studio-bundled", "brikko-studio-managed", "brikko-studio-plugin"],
    canBeOverriddenBy: ["brikko-studio-managed"],
  },
  "brikko-studio-workspace": {
    ...
    canOverride: ["brikko-studio-workspace"],
    canBeOverriddenBy: ["brikko-studio-workspace"],
  },
};
...
export function resolveHookEnableState(params: {
  ...
  if (entry.hook.source === "brikko-studio-plugin") {
    return { enabled: true };
  }
