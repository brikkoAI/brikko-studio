 ...
 */
const INTERNAL_HOOK_HANDLERS_KEY = Symbol.for("brikko-studio.internalHookHandlers");
...
const INTERNAL_HOOKS_ENABLED_KEY = Symbol.for("brikko-studio.internalHooksEnabled");
