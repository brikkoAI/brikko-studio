      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["brikko-studio gateway run", "Run the gateway in the foreground."],
            ["brikko-studio gateway status", "Show service status plus connectivity/capability."],
            ["brikko-studio gateway discover", "Find local and wide-area gateway beacons."],
            ["brikko-studio gateway stability", "Show recent stability diagnostics."],
            ["brikko-studio gateway call health", "Call a gateway RPC method directly."],
          ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/gateway", "docs.brikko-studio.ai/cli/gateway")}\n`,
      ),
  );
