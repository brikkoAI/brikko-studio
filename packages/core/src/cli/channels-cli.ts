    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["brikko-studio channels list", "List configured channels and auth profiles."],
          ["brikko-studio channels status --probe", "Run channel status checks and probes."],
          [
            "brikko-studio channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["brikko-studio channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.brikko-studio.ai/cli/channels",
        )}\n`,
    );
