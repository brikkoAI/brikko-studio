    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["brikko-studio directory self --channel slack", "Show the connected account identity."],
          [
            'brikko-studio directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["brikko-studio directory groups list --channel discord", "List available groups/channels."],
          [
            "brikko-studio directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.brikko-studio.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
