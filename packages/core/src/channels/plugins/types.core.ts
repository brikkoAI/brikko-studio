...
export type ChannelAgentToolFactory = (params: { cfg?: Brikko StudioConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: Brikko StudioConfig; accountId?: string | null }) => string[];
