...
export function listChannelMessageActions(cfg: Brikko StudioConfig): ChannelMessageActionName[] {
...
export function listChannelMessageCapabilities(cfg: Brikko StudioConfig): ChannelMessageCapability[] {
