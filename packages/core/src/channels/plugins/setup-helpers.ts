...
function channelHasAccounts(cfg: BrikkoStudioConfig, channelKey: string): boolean {
...
export function createZodSetupInputValidator<T extends ChannelSetupInput>(params: {
  schema: ZodType<T>;
  validate?: (params: { cfg: BrikkoStudioConfig; accountId: string; input: T }) => string | null;
