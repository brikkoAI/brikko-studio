---
name: optimizetests
description: Optimize Brikko Studio slow tests, imports, misplaced coverage, and CI wall time without dropping coverage.
---

# Optimize Tests

Goal: real Brikko Studio test/runtime speedups with coverage intact. Do not add shards,
...
2. Establish evidence before edits:
   ...
   - Import suspicion: add `BRIKKO_STUDIO_VITEST_IMPORT_DURATIONS=1 BRIKKO_STUDIO_VITEST_PRINT_IMPORT_BREAKDOWN=1`
