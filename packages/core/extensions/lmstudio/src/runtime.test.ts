...
vi.mock("brikko-studio/plugin-sdk/provider-auth-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("brikko-studio/plugin-sdk/provider-auth-runtime")>();
  return {
    ...actual,
