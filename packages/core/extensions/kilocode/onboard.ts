...
export function applyKilocodeProviderConfig(cfg: Brikko StudioConfig): Brikko StudioConfig {
  return kilocodePresetAppliers.applyProviderConfig(cfg);
}

export function applyKilocodeConfig(cfg: Brikko StudioConfig): Brikko StudioConfig {
