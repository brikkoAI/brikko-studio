...
} from "brikko-studio/plugin-sdk/allowlist-config-edit";
...
//
// `brikko-studio/plugin-sdk/channel-policy` is intentionally NOT lazy here —
...
const EXTENSION_SHARED_MODULE_ID = "brikko-studio/plugin-sdk/extension-shared";
const TARGET_RESOLVER_RUNTIME_MODULE_ID = "brikko-studio/plugin-sdk/target-resolver-runtime";
  ...
  base: {
    ...
    actions: createSlackActions(SLACK_CHANNEL, {
      invoke: async (action, cfg, toolContext) =>
        ...
        )(action, cfg as Brikko StudioConfig, toolContext as SlackActionContext | undefined),
    }),
