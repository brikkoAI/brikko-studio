...
function buildConfig(
  execApprovals?: NonNullable<NonNullable<BrikkoStudioConfig["channels"]>["slack"]>["execApprovals"],
  channelOverrides?: Partial<NonNullable<NonNullable<BrikkoStudioConfig["channels"]>["slack"]>>,
): BrikkoStudioConfig {
  return {
    channels: {
      slack: {
