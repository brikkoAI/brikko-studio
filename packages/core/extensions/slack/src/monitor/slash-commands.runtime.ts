...
type BuildCommandTextFromArgs =
  typeof import("brikko-studio/plugin-sdk/command-auth").buildCommandTextFromArgs;
type FindCommandByNativeName =
  typeof import("brikko-studio/plugin-sdk/command-auth").findCommandByNativeName;
type ListNativeCommandSpecsForConfig =
  typeof import("brikko-studio/plugin-sdk/command-auth").listNativeCommandSpecsForConfig;
type ParseCommandArgs = typeof import("brikko-studio/plugin-sdk/command-auth").parseCommandArgs;
type ResolveCommandArgMenu =
  typeof import("brikko-studio/plugin-sdk/command-auth").resolveCommandArgMenu;
