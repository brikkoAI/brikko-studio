...
vi.mock("brikko-studio/plugin-sdk/channel-inbound", async () => {
  const actual = await vi.importActual<typeof import("brikko-studio/plugin-sdk/channel-inbound")>(
    "brikko-studio/plugin-sdk/channel-inbound",
  );
  return {
    ...actual,
