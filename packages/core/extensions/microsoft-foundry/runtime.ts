import type { ProviderPrepareRuntimeAuthContext } from "brikko-studio/plugin-sdk/core";
import { formatErrorMessage } from "brikko-studio/plugin-sdk/error-runtime";
import { ensureAuthProfileStore } from "brikko-studio/plugin-sdk/provider-auth";
