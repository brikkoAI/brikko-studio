...
function baseCfg(): Brikko StudioConfig {
  return {
    channels: {
      imessage: {
        dmPolicy: "open",
...
function buildDispatchContextPayload(params: { cfg: Brikko StudioConfig; message: IMessagePayload }) {
...
describe("imessage monitor gating + envelope builders", () => {
  ...
  it("drops group reply context from non-allowlisted senders in allowlist mode", () => {
    ...
    const message: IMessagePayload = {
      ...
      sender: "+15550001111",
      is_from_me: false,
      text: "@brikko-studio replying now",
      is_group: true,
      reply_to_id: 9001,
  ...
  it("blocks group messages when imessage.groups is set without a wildcard", () => {
    ...
    const decision = resolveIMessageInboundDecision({
      ...
      opts: {},
      messageText: "@brikko-studio hello",
      bodyText: "@brikko-studio hello",
      allowFrom: ["*"],
      groupAllowFrom: [],
      groupPolicy: "open",
      dmPolicy: "open",
  ...
  it("honors group allowlist and ignores pairing-store senders in groups", () => {
    ...
    const denied = resolveIMessageInboundDecision({
      ...
      message: {
        ...
        sender: "+15550003333",
        is_from_me: false,
        text: "@brikko-studio hi",
        is_group: true,
      },
      opts: {},
      messageText: "@brikko-studio hi",
      bodyText: "@brikko-studio hi",
      allowFrom: ["*"],
    ...
    const allowed = resolveIMessageInboundDecision({
      ...
      message: {
        ...
        sender: "+15550003333",
        is_from_me: false,
        text: "@brikko-studio ok",
        is_group: true,
      },
      opts: {},
      messageText: "@brikko-studio ok",
      bodyText: "@brikko-studio ok",
      allowFrom: ["*"],
      groupAllowFrom: ["chat_id:101"],
      groupPolicy: "allowlist",
      dmPolicy: "pairing",
