...
import { normalizeScpRemoteHost } from "brikko-studio/plugin-sdk/host-runtime";
import { runInboundReplyTurn } from "brikko-studio/plugin-sdk/inbound-reply-dispatch";
import { isInboundPathAllowed, kindFromMime } from "brikko-studio/plugin-sdk/media-runtime";
import { DEFAULT_GROUP_HISTORY_LIMIT, type HistoryEntry } from "brikko-studio/plugin-sdk/reply-history";
import { resolveTextChunkLimit } from "brikko-studio/plugin-sdk/reply-runtime";
import { dispatchInboundMessage } from "brikko-studio/plugin-sdk/reply-runtime";
import { createReplyDispatcher } from "brikko-studio/plugin-sdk/reply-runtime";
import { settleReplyDispatcher } from "brikko-studio/plugin-sdk/reply-runtime";
import { getRuntimeConfig } from "brikko-studio/plugin-sdk/runtime-config-snapshot";
import { danger, logVerbose, shouldLogVerbose, warn } from "brikko-studio/plugin-sdk/runtime-env";
import {
 ...
 *   exec ssh -T brikko-studio@192.168.64.3 /opt/homebrew/bin/imsg "$@"
...
async function detectRemoteHostFromCliPath(cliPath: string): Promise<string | undefined> {
  try {
    ...
    // Match user@host pattern first (e.g., brikko-studio@192.168.64.3)
