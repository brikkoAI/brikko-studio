...
import { resolveDualTextControlCommandGate } from "brikko-studio/plugin-sdk/command-auth";
...
import { sanitizeTerminalText } from "brikko-studio/plugin-sdk/text-runtime";
