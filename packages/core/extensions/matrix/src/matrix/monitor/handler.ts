...
import type { GetReplyOptions } from "brikko-studio/plugin-sdk/reply-runtime";
...
let acpBindingRuntimePromise:
  | Promise<typeof import("brikko-studio/plugin-sdk/acp-binding-runtime")>
  | undefined;
let sessionBindingRuntimePromise:
  | Promise<typeof import("brikko-studio/plugin-sdk/session-binding-runtime")>
  | undefined;
...
function loadAcpBindingRuntime(): Promise<
  typeof import("brikko-studio/plugin-sdk/acp-binding-runtime")
> {
  acpBindingRuntimePromise ??= import("brikko-studio/plugin-sdk/acp-binding-runtime");
  return acpBindingRuntimePromise;
}

function loadSessionBindingRuntime(): Promise<
  typeof import("brikko-studio/plugin-sdk/session-binding-runtime")
> {
  sessionBindingRuntimePromise ??= import("brikko-studio/plugin-sdk/session-binding-runtime");
...
function buildMatrixFinalizedPreviewContent(): Record<string, unknown> {
  return { [MATRIX_BRIKKO_STUDIO_FINALIZED_PREVIEW_KEY]: true };
}
