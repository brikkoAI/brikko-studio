import { resolveConfiguredAcpBindingRecord } from "brikko-studio/plugin-sdk/acp-binding-resolve-runtime";
...
import { getSessionBindingService } from "brikko-studio/plugin-sdk/session-binding-runtime";
