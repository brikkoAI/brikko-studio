...
describe("createMatrixClient", () => {
  const storagePaths = {
    rootDir: "/tmp/brikko-studio-matrix-create-client-test",
    storagePath: "/tmp/brikko-studio-matrix-create-client-test/storage.json",
    recoveryKeyPath: "/tmp/brikko-studio-matrix-create-client-test/recovery.key",
    idbSnapshotPath: "/tmp/brikko-studio-matrix-create-client-test/idb.snapshot",
    metaPath: "/tmp/brikko-studio-matrix-create-client-test/storage-meta.json",
    accountKey: "default",
  ...
  it("persists storage metadata by default", async () => {
    ...
    expect(MatrixClientMock).toHaveBeenCalledWith("https://matrix.example.org", "tok", {
      ...
      cryptoDatabasePrefix: "brikko-studio-matrix-default-token-hash",
