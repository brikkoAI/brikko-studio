import type { OutputRuntimeEnv } from "brikko-studio/plugin-sdk/runtime";
import type { ChannelSetupWizardAdapter } from "brikko-studio/plugin-sdk/setup";
...
export function createMatrixUpdateKeepCredentialsPrompter(params?: {
  ...
  return createMatrixWizardPrompter({
    ...
    text: {
      ...
      "Matrix device name (optional)": params?.deviceName ?? "Brikko Studio Gateway",
    },
    confirm: {
