...
import { writeFileWithinRoot } from "brikko-studio/plugin-sdk/file-access-runtime";
import type {
  SandboxFsBridge,
  SandboxFsStat,
  SandboxResolvedPath,
} from "brikko-studio/plugin-sdk/sandbox";
import { createWritableRenameTargetResolver } from "brikko-studio/plugin-sdk/sandbox";
...
// import, and this helper is not yet part of the `brikko-studio/plugin-sdk/*`
