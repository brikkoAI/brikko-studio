...
This package contains the **BlueBubbles external channel plugin** for Brikko Studio.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `brikko-studio/plugin-sdk` helpers.
