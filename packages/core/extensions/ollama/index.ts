...
import { buildApiKeyCredential } from "brikko-studio/plugin-sdk/provider-auth";
import type {
...
export default definePluginEntry({
  ...
  register(api: Brikko StudioPluginApi) {
    ...
    const resolveCurrentPluginConfig = (config?: Brikko StudioConfig): OllamaPluginConfig => {
    ...
    api.registerProvider({
      ...
      buildUnknownModelHint: () =>
        ...
        'Set OLLAMA_API_KEY="ollama-local" (any value works) or run "brikko-studio configure". ' +
        "See: https://docs.brikko-studio.ai/providers/ollama",
    });
  },
});
