...
vi.mock("brikko-studio/plugin-sdk/outbound-media", () => ({
...
describe("zalo outbound hosted media", () => {
  ...
  it("loads outbound media under Brikko Studio control and returns a hosted URL", async () => {
  ...
  it("creates hosted media storage with private filesystem permissions", async () => {
    ...
    const storageDir = join(resolvePreferredBrikko StudioTmpDir(), "brikko-studio-zalo-outbound-media");
