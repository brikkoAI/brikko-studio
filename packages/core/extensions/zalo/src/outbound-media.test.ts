...
describe("zalo outbound hosted media", () => {
  ...
  it("loads outbound media under BrikkoStudio control and returns a hosted URL", async () => {
  ...
  it("creates hosted media storage with private filesystem permissions", async () => {
    ...
    const storageDir = join(resolvePreferredBrikkoStudioTmpDir(), "brikko-studio-zalo-outbound-media");
