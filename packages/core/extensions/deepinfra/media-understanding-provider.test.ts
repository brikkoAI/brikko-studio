...
vi.mock("brikko-studio/plugin-sdk/media-understanding", async () => {
  const actual = await vi.importActual<typeof import("brikko-studio/plugin-sdk/media-understanding")>(
    "brikko-studio/plugin-sdk/media-understanding",
  );
  return {
    ...actual,
