...
import { fetchWithTimeout } from "brikko-studio/plugin-sdk/provider-http";
...
export const DEEPINFRA_MODELS_URL = `${DEEPINFRA_BASE_URL}/models?sort_by=brikko-studio&filter=with_meta`;
