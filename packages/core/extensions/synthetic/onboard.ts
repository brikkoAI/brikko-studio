...
export function applySyntheticProviderConfig(cfg: BrikkoStudioConfig): BrikkoStudioConfig {
  return syntheticPresetAppliers.applyProviderConfig(cfg);
}

export function applySyntheticConfig(cfg: BrikkoStudioConfig): BrikkoStudioConfig {
