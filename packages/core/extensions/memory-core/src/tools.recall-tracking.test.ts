...
function asBrikkoStudioConfig(config: Partial<BrikkoStudioConfig>): BrikkoStudioConfig {
  return config;
}

function createSearchTool(config: BrikkoStudioConfig) {
