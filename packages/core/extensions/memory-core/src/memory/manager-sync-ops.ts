...
import { classifyMemoryMultimodalPath } from "brikko-studio/plugin-sdk/memory-core-host-engine-embeddings";
import {
...
const TEST_MEMORY_WATCH_FACTORY_KEY = Symbol.for("brikko-studio.test.memoryWatchFactory");
  ...
  protected async runSync(params?: {
    ...
    const targetedSessionSync = await runMemoryTargetedSessionSync({
      ...
      useUnsafeReindex:
        ...
        process.env.BRIKKO_STUDIO_TEST_MEMORY_UNSAFE_REINDEX === "1",
      sessionsDirtyFiles: this.sessionsDirtyFiles,
