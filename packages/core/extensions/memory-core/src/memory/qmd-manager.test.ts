...
const MEMORY_EMBEDDING_PROVIDERS_KEY = Symbol.for("brikko-studio.memoryEmbeddingProviders");
const MCPORTER_STATE_KEY = Symbol.for("brikko-studio.mcporterState");
const QMD_EMBED_QUEUE_KEY = Symbol.for("brikko-studio.qmdEmbedQueueTail");
...
vi.mock("brikko-studio/plugin-sdk/memory-core-host-engine-foundation", async () => {
  const actual = await vi.importActual<
    typeof import("brikko-studio/plugin-sdk/memory-core-host-engine-foundation")
  >("brikko-studio/plugin-sdk/memory-core-host-engine-foundation");
  return {
    ...actual,
...
vi.mock("brikko-studio/plugin-sdk/file-lock", async () => {
  const actual = await vi.importActual<typeof import("brikko-studio/plugin-sdk/file-lock")>(
    "brikko-studio/plugin-sdk/file-lock",
  );
  return {
    ...actual,
