...
const QQBOT_PLUGIN_GITHUB_URL = "https://github.com/brikko-studio/brikko-studio/tree/main/extensions/qqbot";
const QQBOT_UPGRADE_GUIDE_URL = "https://q.qq.com/qqbot/brikko-studio/upgrade.html";
