...
export const qqbotPlugin: ChannelPlugin<ResolvedQQBotAccount> = {
  ...
  config: {
     ...
     * that wiped brikko-studio.json mid-flight.
     */
  ...
  gateway: {
    startAccount: async (ctx) => {
      ...
      // brikko-studio.json). We only restore when both fields are empty so a
      ...
      await startGateway({
        ...
        onReady: () => {
          ...
          // upgrade that might wipe brikko-studio.json mid-flight.
