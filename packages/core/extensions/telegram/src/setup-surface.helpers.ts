...
export function shouldShowTelegramDmAccessWarning(cfg: Brikko StudioConfig, accountId: string): boolean {
...
export function buildTelegramDmAccessWarningLines(accountId: string): string[] {
  ...
  return [
    ...
    "  " + formatCliCommand(`brikko-studio config set ${configBase}.dmPolicy "allowlist"`),
    "  " + formatCliCommand(`brikko-studio config set ${configBase}.allowFrom '["YOUR_USER_ID"]'`),
