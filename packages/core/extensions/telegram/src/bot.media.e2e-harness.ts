...
import { resetInboundDedupe } from "brikko-studio/plugin-sdk/reply-runtime";
...
type DispatchReplyWithBufferedBlockDispatcherFn =
  typeof import("brikko-studio/plugin-sdk/reply-runtime").dispatchReplyWithBufferedBlockDispatcher;
type DispatchReplyHarnessParams = Parameters<DispatchReplyWithBufferedBlockDispatcherFn>[0];
type FetchRemoteMediaFn = typeof import("brikko-studio/plugin-sdk/media-runtime").fetchRemoteMedia;
...
export const telegramBotDepsForTest: TelegramBotDeps = {
  getRuntimeConfig: (() =>
    ...
    }) as Brikko StudioConfig) as TelegramBotDeps["getRuntimeConfig"],
