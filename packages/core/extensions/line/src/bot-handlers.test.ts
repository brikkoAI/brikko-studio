...
vi.mock("brikko-studio/plugin-sdk/channel-inbound", () => ({
  buildMentionRegexes: () => [],
...
vi.mock("brikko-studio/plugin-sdk/channel-pairing", () => ({
...
vi.mock("brikko-studio/plugin-sdk/command-auth", () => ({
...
vi.mock("brikko-studio/plugin-sdk/runtime-group-policy", () => ({
...
vi.mock("brikko-studio/plugin-sdk/group-access", () => ({
...
vi.mock("brikko-studio/plugin-sdk/routing", () => ({
