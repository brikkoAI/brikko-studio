...
vi.mock("./nostr-profile-http-runtime.js", async () => {
  const webhookIngress = await import("brikko-studio/plugin-sdk/webhook-ingress");
  const requestGuards = await import("brikko-studio/plugin-sdk/webhook-request-guards");
  return {
