...
Nostr DM channel plugin for Brikko Studio using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to Brikko Studio. It enables your bot to:
...
# Configure brikko-studio to use local relay
