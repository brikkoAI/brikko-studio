...
import { isSingleUseReplyToMode } from "brikko-studio/plugin-sdk/reply-reference";
...
export function resetDiscordComponentRuntimeMocks() {
  ...
  resolveStorePathMock.mockClear().mockReturnValue("/tmp/brikko-studio-sessions-test.json");
