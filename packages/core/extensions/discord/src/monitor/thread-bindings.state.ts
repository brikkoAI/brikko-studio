...
import { loadJsonFile, saveJsonFile } from "brikko-studio/plugin-sdk/json-store";
...
// registry.
const THREAD_BINDINGS_STATE_KEY = Symbol.for("brikko-studio.discordThreadBindingsState");
