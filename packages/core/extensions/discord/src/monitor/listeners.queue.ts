import { createSubsystemLogger, formatDurationSeconds } from "brikko-studio/plugin-sdk/runtime-env";

export type DiscordListenerLogger = ReturnType<
  typeof import("brikko-studio/plugin-sdk/runtime-env").createSubsystemLogger
>;
