...
let modelsProviderRuntimePromise:
  | Promise<typeof import("brikko-studio/plugin-sdk/models-provider-runtime")>
  | undefined;

async function loadModelsProviderRuntime() {
  modelsProviderRuntimePromise ??= import("brikko-studio/plugin-sdk/models-provider-runtime");
