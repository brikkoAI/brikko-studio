...
let runtimeEnvModule: typeof import("brikko-studio/plugin-sdk/runtime-env");
...
describe("monitorDiscordProvider", () => {
  ...
  beforeAll(async () => {
    vi.doMock("brikko-studio/plugin-sdk/plugin-runtime", async () => {
    ...
    runtimeEnvModule = await import("brikko-studio/plugin-sdk/runtime-env");
