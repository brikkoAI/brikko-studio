...
vi.mock("brikko-studio/plugin-sdk/approval-gateway-runtime", async (importOriginal) => {
  const actual =
    await importOriginal<typeof import("brikko-studio/plugin-sdk/approval-gateway-runtime")>();
  return {
    ...actual,
