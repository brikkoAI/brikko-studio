...
const DISCORD_COMPONENT_ENTRIES_KEY = Symbol.for("brikko-studio.discord.componentEntries");
const DISCORD_MODAL_ENTRIES_KEY = Symbol.for("brikko-studio.discord.modalEntries");
