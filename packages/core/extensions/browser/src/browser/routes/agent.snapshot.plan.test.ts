...
function profile(driver: "existing-session" | "brikko-studio"): ResolvedBrowserProfile {
  return {
    name: driver === "existing-session" ? "user" : "brikko-studio",
    driver,
