...
export function resolveCdpReachabilityPolicy(
  ...
  // The browser SSRF policy protects page/network navigation, not Brikko Studio's
  ...
  if (!capabilities.isRemote && profile.cdpIsLoopback && profile.driver === "brikko-studio") {
    return undefined;
  }
