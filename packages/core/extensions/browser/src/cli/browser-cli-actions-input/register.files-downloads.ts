...
export function registerBrowserFilesAndDownloadsCommands(
  ...
  browser
    ...
    .argument(
      "<paths...>",
      "File paths to upload (must be within Brikko Studio temp uploads dir, e.g. /tmp/brikko-studio/uploads/file.pdf)",
    )
  ...
  browser
    ...
    .argument(
      "[path]",
      "Save path within brikko-studio temp downloads dir (default: /tmp/brikko-studio/downloads/...; fallback: os.tmpdir()/brikko-studio/downloads/...)",
    )
    .option("--target-id <id>", "CDP target id (or unique prefix)")
    .option(
      "--timeout-ms <ms>",
  ...
  browser
    ...
    .argument(
      "<path>",
      "Save path within brikko-studio temp downloads dir (e.g. report.pdf or /tmp/brikko-studio/downloads/report.pdf)",
    )
    .option("--target-id <id>", "CDP target id (or unique prefix)")
    .option(
      "--timeout-ms <ms>",
