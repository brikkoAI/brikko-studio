import type { MemoryEmbeddingProviderCreateOptions } from "brikko-studio/plugin-sdk/memory-core-host-engine-embeddings";
...
vi.mock("brikko-studio/plugin-sdk/memory-core-host-engine-embeddings", () => ({
