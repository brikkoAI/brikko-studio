...
import type { ProviderPlugin } from "brikko-studio/plugin-sdk/provider-test-contracts";
...
vi.mock("brikko-studio/plugin-sdk/provider-catalog-runtime", async () => {
  const actual = await vi.importActual<
    typeof import("brikko-studio/plugin-sdk/provider-catalog-runtime")
  >("brikko-studio/plugin-sdk/provider-catalog-runtime");
