...
function applyCopilotDefaultModel(cfg: Brikko StudioConfig): Brikko StudioConfig {
...
export default definePluginEntry({
  ...
  register(api) {
    ...
    function resolveCurrentPluginConfig(config?: Brikko StudioConfig): GithubCopilotPluginConfig {
