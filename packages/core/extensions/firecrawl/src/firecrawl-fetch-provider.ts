import type { WebFetchProviderPlugin } from "brikko-studio/plugin-sdk/provider-web-fetch";
import { enablePluginInConfig } from "brikko-studio/plugin-sdk/provider-web-fetch";
