import { createQueuedWizardPrompter } from "brikko-studio/plugin-sdk/plugin-test-runtime";
...
vi.mock("brikko-studio/plugin-sdk/setup", async () => {
  const actual = await vi.importActual<typeof import("brikko-studio/plugin-sdk/setup")>(
    "brikko-studio/plugin-sdk/setup",
  );
...
describe("whatsapp setup wizard", () => {
  beforeEach(() => {
    ...
    hoisted.resolveWhatsAppAuthDir.mockReturnValue({ authDir: "/tmp/brikko-studio-whatsapp-test" });
  });
