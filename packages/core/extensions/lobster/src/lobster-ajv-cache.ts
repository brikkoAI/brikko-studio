...
const installedSymbol = Symbol.for("brikko-studio.lobster.ajv-compile-cache.installed");
const cacheSymbol = Symbol.for("brikko-studio.lobster.ajv-compile-cache.entries");
