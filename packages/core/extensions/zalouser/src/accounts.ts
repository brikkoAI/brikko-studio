...
function mergeZalouserAccountConfig(cfg: Brikko StudioConfig, accountId: string): ZalouserAccountConfig {
...
function resolveZalouserAccountBase(params: { cfg: Brikko StudioConfig; accountId?: string | null }) {
