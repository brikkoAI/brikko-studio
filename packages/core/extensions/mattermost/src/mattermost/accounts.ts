import { createAccountListHelpers } from "brikko-studio/plugin-sdk/account-helpers";
import { DEFAULT_ACCOUNT_ID, normalizeAccountId } from "brikko-studio/plugin-sdk/account-id";
import { resolveMergedAccountConfig } from "brikko-studio/plugin-sdk/account-resolution";
import {
...
export function listMattermostAccountIds(cfg: Brikko StudioConfig): string[] {
  return mattermostAccountHelpers.listAccountIds(cfg);
}

export function resolveDefaultMattermostAccountId(cfg: Brikko StudioConfig): string {
