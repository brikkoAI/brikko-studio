...
vi.mock("brikko-studio/plugin-sdk/core", async () => {
  const actual = await vi.importActual<typeof import("brikko-studio/plugin-sdk/core")>(
    "brikko-studio/plugin-sdk/core",
  );
  return {
    ...actual,
