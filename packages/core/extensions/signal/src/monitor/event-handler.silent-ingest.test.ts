...
vi.mock("brikko-studio/plugin-sdk/hook-runtime", async () => {
  const actual = await vi.importActual<typeof import("brikko-studio/plugin-sdk/hook-runtime")>(
    "brikko-studio/plugin-sdk/hook-runtime",
  );
  return {
    ...actual,
