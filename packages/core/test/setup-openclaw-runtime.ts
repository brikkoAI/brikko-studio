...
const WORKER_RUNTIME_STATE = Symbol.for("brikko-studio.testSetupRuntimeState");
const WORKER_PLUGIN_RUNTIME_HELPERS = Symbol.for("brikko-studio.testSetupPluginRuntimeHelpers");
const WORKER_CLEANUP_HELPERS = Symbol.for("brikko-studio.testSetupCleanupHelpers");
...
const createStubPlugin = (params: {
  ...
  config: {
    ...
    isConfigured: async (_account, cfg: Brikko StudioConfig) => {
      const channels = cfg.channels as Record<string, unknown> | undefined;
