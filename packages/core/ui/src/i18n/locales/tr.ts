...
export const tr: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "brikko-studio.json dosyasını düzenleyin.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Mobilde misiniz? Masaüstünüzde brikko-studio dashboard --no-open komutundan tam URL'yi (#token=... dahil) kopyalayın.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc:
        "{providers} — brikko-studio models auth ile yeniden kimlik doğrulayın",
