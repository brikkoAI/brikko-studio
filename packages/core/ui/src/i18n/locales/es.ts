...
export const es: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "Editar ~/.brikko-studio/brikko-studio.json de forma segura.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "¿En el móvil? Copia la URL completa (incluyendo #token=...) desde brikko-studio dashboard --no-open en tu escritorio.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — vuelve a autenticarte con brikko-studio models auth",
