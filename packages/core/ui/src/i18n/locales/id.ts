...
export const id: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "Edit brikko-studio.json.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Di seluler? Salin URL lengkap (termasuk #token=...) dari brikko-studio dashboard --no-open di desktop Anda.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — autentikasi ulang dengan brikko-studio models auth",
