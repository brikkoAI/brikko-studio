...
export const de: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "~/.brikko-studio/brikko-studio.json sicher bearbeiten.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Auf dem Mobilgerät? Kopieren Sie die vollständige URL (einschließlich #token=...) von brikko-studio dashboard --no-open auf Ihrem Desktop.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc:
        "{providers} — mit brikko-studio models auth erneut authentifizieren",
