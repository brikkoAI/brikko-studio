...
export const zh_CN: TranslationMap = {
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "在手机上？从桌面运行 brikko-studio dashboard --no-open 复制完整 URL（包括 #token=...）。",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — 使用 brikko-studio models auth 重新认证",
