      ...
      <div class="login-gate__card">
          ...
          <label class="field">
            ...
            <div class="login-gate__secret-row">
              <input
                ...
                placeholder="BRIKKO_STUDIO_GATEWAY_TOKEN (${t("login.passwordPlaceholder")})"
        ...
        <div class="login-gate__help">
          ...
          <ol class="login-gate__steps">
            <li>
              ${t("overview.connection.step1")}${renderConnectCommand("brikko-studio gateway run")}
            </li>
            <li>${t("overview.connection.step2")} ${renderConnectCommand("brikko-studio dashboard")}</li>
